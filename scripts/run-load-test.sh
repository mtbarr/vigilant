...
echo "=== Baixando load test oficial da Rinha ==="
curl -sL https://raw.githubusercontent.com/zanfranceschi/rinha-de-backend-2026/main/test/test.js \
    -o /tmp/rinha-load.js
curl -sL https://raw.githubusercontent.com/zanfranceschi/rinha-de-backend-2026/main/test/test-data.json \
    -o /tmp/test-data.json
...
mkdir -p test
K6_NO_USAGE_REPORT=true k6 run /tmp/rinha-load.js \
    --out json=/tmp/rinha-metrics.json
